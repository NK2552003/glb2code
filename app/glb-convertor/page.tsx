...
export default function GLBConverter() {
  ...
  const langExt = useMemo(
    () => LANGUAGES.find((l) => l.id === selectedLanguage)?.extension || "tsx",
    [selectedLanguage]
  );
            ...
            {activeTab === "code" && projectStructure ? (
              <div className="flex-1 overflow-y-auto px-1 py-2">
                <FileTree
                  ...
                  toggleFolder={
                    toggleFolder as unknown as (folder: string) => void
                  }
              ...
              <div className="flex-1 overflow-y-auto p-4 items-center">
                <div className="text-slate-400/80 text-sm space-y-3 text-center h-full">
                  {activeTab === "upload" ? (
                    ...
                    <div className="space-y-2">
                      <p>
                        Select a file from the project structure to view its
                        code.
                      </p>
                      <p>
                  ...
                  <div
                    className={`rounded-lg border-2 border-dashed p-12 text-center transition-colors flex flex-col justify-center items-center h-full ${
                      isDragging
                        ...
                        : "border-white/10 hover:border-fuchsia-500/50"
                    }`}
                    onDragOver={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
