...
(()=>{
    const e = new Error("Cannot find module '../components/language-selector'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../components/file-tree'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../components/model-preview'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
//# sourceMappingURL=_ae7fc987._.js.map