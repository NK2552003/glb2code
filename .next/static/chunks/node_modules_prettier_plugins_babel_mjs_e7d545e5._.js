...
"[project]/node_modules/prettier/plugins/babel.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var Ci = (a, t)=>()=>(t || a((t = {
    ...
    for(var e in t)_e(a, e, {
        get: t[e],
        enumerable: !0
    });
}, wi = (a, t, e, s)=>{
    if (t && typeof t == "object" || typeof t == "function") for (let i of Ai(t))!Ei.call(a, i) && i !== e && _e(a, i, {
        get: ()=>t[i],
        enumerable: !(s = bi(t, i)) || s.enumerable
    });
    return a;
};
var ls = (a, t, e)=>(e = a != null ? Ti(Si(a)) : {}, wi(t || !a || !a.__esModule ? _e(e, "default", {
        value: a,
        enumerable: !0
    }) : e, a));
var Tt = Ci((Pe)=>{
    ...
    var hs = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", Ni = {
    ...
    }, Se = (a)=>a.type === "UpdateExpression" ? cs.UpdateExpression["".concat(a.prefix)] : cs[a.type], ki = {
        ...
        InvalidLhs: (param)=>{
            ...
            return "Invalid left-hand side in ".concat(Se(a), ".");
        },
        InvalidLhsBinding: (param)=>{
            let { ancestor: a } = param;
            return "Binding invalid left-hand side in ".concat(Se(a), ".");
        },
        InvalidLhsOptionalChaining: (param)=>{
            let { ancestor: a } = param;
            return "Invalid optional chaining in the left-hand side of ".concat(Se(a), ".");
        },
        ...
        PipeUnparenthesizedBody: (param)=>{
            let { type: a } = param;
            return "Hack-style pipe body cannot be an unparenthesized ".concat(Se({
                type: a
            ...
            fillOptionalPropertiesForTSESLint(e) {
                ...
                switch(e.type){
                    ...
                    case "AccessorProperty":
                        ($ = e.declare) != null || (e.declare = !1), (Ot = e.definite) != null || (e.definite = !1), (Ft = e.readonly) != null || (e.readonly = !1), (Bt = e.typeAnnotation) != null || (e.typeAnnotation = void 0);
                    case "TSAbstractMethodDefinition":
                    case "MethodDefinition":
                        (Rt = e.accessibility) != null || (e.accessibility = void 0), (_t = e.decorators) != null || (e.decorators = []), (Ut = e.override) != null || (e.override = !1), (jt = e.optional) != null || (e.optional = !1);
                        return;
                    case "ClassExpression":
                        ($t = e.id) != null || (e.id = null);
                    case "ClassDeclaration":
                        (Vt = e.abstract) != null || (e.abstract = !1), (qt = e.declare) != null || (e.declare = !1), (zt = e.decorators) != null || (e.decorators = []), (Ht = e.implements) != null || (e.implements = []), (Kt = e.superTypeArguments) != null || (e.superTypeArguments = void 0), (Wt = e.typeParameters) != null || (e.typeParameters = void 0);
                        return;
                    ...
                    case "VariableDeclarator":
                        ...
                        return;
                    case "TSEnumDeclaration":
                        (Gt = e.const) != null || (e.const = !1), (Yt = e.declare) != null || (e.declare = !1);
                        return;
                    case "TSEnumMember":
                    ...
                    case "TSInterfaceDeclaration":
                        (ts = e.declare) != null || (e.declare = !1), (ss = e.extends) != null || (e.extends = []);
                        return;
                    case "TSModuleDeclaration":
                        (is = e.declare) != null || (e.declare = !1), (rs = e.global) != null || (e.global = e.kind === "global");
                        return;
                    case "TSTypeParameter":
                        (as = e.const) != null || (e.const = !1), (ns = e.in) != null || (e.in = !1), (os = e.out) != null || (e.out = !1);
                        return;
                }
            }
            constructor(...e){
    ...
    var _s = {
        ...
        parseExprOp(t, e, s) {
            if (this.isPrivateName(t)) {
                ...
                (s >= Ee(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(p.PrivateInExpectedIn, t, {
                    identifierName: r
            ...
            if (Ki(i) && (this.prodParam.hasIn || !this.match(58))) {
                ...
                if (r > s) {
                    ...
                    if (l && (r = Ee(42)), this.next(), i === 39 && this.hasPlugin([
                        "pipelineOperator",
                        {
                            proposal: "minimal"
                        }
...
function ua(a) {
    ...
    return t.endsWith(o) && (t = t.slice(0, -o.length)), t.startsWith(ri) && (t = t.slice(ri.length)), De(t, {
        loc: {
            start: {
                line: i,
                column: r + 1
...
function K(a, t) {
    ...
    return De("".concat(t, " is not allowed in JSON."), {
        loc: {
            start: e,
            end: s
        }
...
//# sourceMappingURL=node_modules_prettier_plugins_babel_mjs_e7d545e5._.js.map