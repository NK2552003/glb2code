...
var Pn = Cu((Mt)=>{
    ...
    function go(e, t) {
        ...
        let u = Co(!1), o = e.split(On), { start: i, end: s, markerLines: a } = ho(t, o, r), c = t.start && typeof t.start.column == "number", D = String(s).length, l = e.split(On, s).slice(i, s).map((F, f)=>{
            let d = i + 1 + f, C = " ".concat(" ".concat(d).slice(-D), " |"), E = a[d], h = !a[d + 1];
            if (E) {
                let x = "";
                if (Array.isArray(E)) {
            ...
            } else return " ".concat(u.gutter(C)).concat(F.length > 0 ? " ".concat(F) : "");
        }).join("\n");
        return r.message && !c && (l = "".concat(" ".repeat(D + 1)).concat(r.message, "\n").concat(l)), l;
    }
...
var ht = class extends Error {
    constructor(t){
        super(wu(t)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "name", "InvalidDocError"), this.doc = t;
    }
}, q = ht;
var ir = {};
function bu(e, t, r, n) {
...
function wr(e) {
    ...
    function n(o, i, s) {
        ...
        if (o.type === _) return "ifBreak(" + n(o.breakContents) + (o.flatContents ? ", " + n(o.flatContents) : "") + (o.groupId ? (o.flatContents ? "" : ', ""') + ", { groupId: ".concat(u(o.groupId), " }") : "") + ")";
        if (o.type === v) {
            let D = [];
            o.negate && D.push("negate: true"), o.groupId && D.push("groupId: ".concat(u(o.groupId)));
            let p = D.length > 0 ? ", { ".concat(D.join(", "), " }") : "";
            return "indentIfBreak(".concat(n(o.contents)).concat(p, ")");
        }
        if (o.type === B) {
            let D = [];
            o.break && o.break !== "propagated" && D.push("shouldBreak: true"), o.id && D.push("id: ".concat(u(o.id)));
            let p = D.length > 0 ? ", { ".concat(D.join(", "), " }") : "";
            return o.expandedStates ? "conditionalGroup([".concat(o.expandedStates.map((l)=>n(l)).join(","), "]").concat(p, ")") : "group(".concat(n(o.contents)).concat(p, ")");
        }
        if (o.type === k) return "fill([".concat(o.parts.map((D)=>n(D)).join(", "), "])");
        if (o.type === L) return "lineSuffix(" + n(o.contents) + ")";
        if (o.type === I) return "lineSuffixBoundary";
        if (o.type === S) return "label(".concat(JSON.stringify(o.label), ", ").concat(n(o.contents), ")");
    ...
    function u(o) {
        ...
        for(let s = 0;; s++){
            let a = i + (s > 0 ? " #".concat(s) : "");
            if (!r.has(a)) return r.add(a), t[o] = "Symbol.for(".concat(JSON.stringify(a), ")");
        }
    }
}
...
function xt(e, t, r) {
    ...
    for (let f of n)switch(f.type){
        ...
        case "numberAlign":
            ...
            break;
        default:
            throw new Error("Unexpected type '".concat(f.type, "'"));
    }
    return l(), {
        ...e,
        value: u,
    ...
    for(; r >= 0;){
        ...
        switch(p){
            ...
            case k:
                {
                    var _D__t;
                    let l = p === Y ? D : D.parts, F = (_D__t = D[_t]) !== null && _D__t !== void 0 ? _D__t : 0;
    ...
    for(cr(e); i.length > 0;){
        ...
        switch(M(f)){
            ...
            case k:
                {
                    var _f__t;
                    let d = n - o, m = (_f__t = f[_t]) !== null && _f__t !== void 0 ? _f__t : 0, { parts: C } = f, E = C.length - m;
                    if (E === 0) break;
...
var Z, kt, ze, bt = class {
    get key() {
        ...
        var _y;
        return (_y = y(!1, t, r === null ? -2 : -4)) !== null && _y !== void 0 ? _y : null;
    }
    get index() {
...
function St(e, t) {
    var _e_comments;
    ((_e_comments = e.comments) !== null && _e_comments !== void 0 ? _e_comments : e.comments = []).push(t), t.printed = !1, t.nodeDescription = Mu(e);
}
function se(e, t) {
...
function Xe(e, t) {
    ...
    if (!n) return [];
    var _ref;
    let s = ((_ref = r == null ? void 0 : r(e, t)) !== null && _ref !== void 0 ? _ref : [
        ...Ce(e, {
            getVisitorKeys: J(u)
        })
    ]).flatMap((a)=>n(a) ? [
...
function jr(e, t) {
    ...
    for(i = r; i > 0; --i){
        ...
        var _ref;
        if ((_ref = (a = (s = t.printer).isGap) == null ? void 0 : a.call(s, l, t)) !== null && _ref !== void 0 ? _ref : /^[\s(]*$/u.test(l)) o = t.locStart(c);
        else break;
    }
...
var ve = class extends Error {
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "name", "ConfigError");
    }
}, Le = class extends Error {
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "name", "UndefinedParserError");
    }
};
var zr = {
    checkIgnorePragma: {
...
function Qe() {
    let { plugins: e = [], showDeprecated: t = !1 } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    let r = e.flatMap((u)=>{
        var _u_languages;
        return (_u_languages = u.languages) !== null && _u_languages !== void 0 ? _u_languages : [];
    }), n = [];
    for (let u of Zu(Object.assign({}, ...e.map((param)=>{
        let { options: o } = param;
        return o;
    }), zr)))!t && u.deprecated || (Array.isArray(u.choices) && (t || (u.choices = u.choices.filter((o)=>!o.deprecated)), u.name === "parser" && (u.choices = [
        ...u.choices,
        ...Qu(u.choices, r, e)
...
function* Qu(e, t, r) {
    ...
    for (let u of t)if (u.parsers) {
        for (let o of u.parsers)if (!n.has(o)) {
            ...
            i != null && i.name && (s += " (plugin: ".concat(i.name, ")")), yield {
                value: o,
                description: s
            };
        }
...
function en(e) {
    if (e = e instanceof URL ? e : new URL(e), e.protocol !== "file:") throw new TypeError('URL must be a file URL: received "'.concat(e.protocol, '"'));
    return e;
}
function ro(e) {
...
function no(e) {
    ...
    return e.hostname !== "" && (t = "\\\\".concat(e.hostname).concat(t)), t;
}
function tn(e) {
    return to ? no(e) : ro(e);
}
...
function nn(e, t) {
    ...
    var _e_find;
    return (_e_find = e.find((param)=>{
        let { filenames: n } = param;
        return n == null ? void 0 : n.some((u)=>u.toLowerCase() === r);
    })) !== null && _e_find !== void 0 ? _e_find : e.find((param)=>{
        let { extensions: n } = param;
        return n == null ? void 0 : n.some((u)=>r.endsWith(u));
    });
}
function oo(e, t) {
    var _e_find, _ref;
    if (t) return (_ref = (_e_find = e.find((param)=>{
        let { name: r } = param;
        return r.toLowerCase() === t;
    })) !== null && _e_find !== void 0 ? _e_find : e.find((param)=>{
        let { aliases: r } = param;
        return r == null ? void 0 : r.includes(t);
    })) !== null && _ref !== void 0 ? _ref : e.find((param)=>{
        let { extensions: r } = param;
        return r == null ? void 0 : r.includes(".".concat(t));
    });
}
function un(e, t) {
    if (t) {
        ...
        if (typeof t == "string") return e.find((param)=>{
            let { isSupported: r } = param;
...
function io(e, t) {
    var _oo, _ref, _ref1, _ref2, _ref3;
    let r = Hr(!1, e.plugins).flatMap((u)=>{
        var _u_languages;
        return (_u_languages = u.languages) !== null && _u_languages !== void 0 ? _u_languages : [];
    }), n = (_ref3 = (_ref2 = (_ref1 = (_ref = (_oo = oo(r, t.language)) !== null && _oo !== void 0 ? _oo : nn(r, t.physicalFile)) !== null && _ref !== void 0 ? _ref : nn(r, t.file)) !== null && _ref1 !== void 0 ? _ref1 : un(r, t.physicalFile)) !== null && _ref2 !== void 0 ? _ref2 : un(r, t.file)) !== null && _ref3 !== void 0 ? _ref3 : (t.physicalFile, void 0);
...
var re = {
    ...
    value (e) {
        ...
        if (Array.isArray(e)) return "[".concat(e.map((r)=>re.value(r)).join(", "), "]");
        let t = Object.keys(e);
        return t.length === 0 ? "{}" : "{ ".concat(t.map((r)=>"".concat(re.key(r), ": ").concat(re.value(e[r]))).join(", "), " }");
    },
    pair: (param)=>{
        let { key: e, value: t } = param;
        return re.value({
            [e]: t
        });
    }
...
var an = (e, t, param)=>{
    let { descriptor: r } = param;
    let n = [
        "".concat(V.yellow(typeof e == "string" ? r.key(e) : r.pair(e)), " is deprecated")
    ];
    return t && n.push("we now treat it as ".concat(V.blue(typeof t == "string" ? r.key(t) : r.pair(t)))), n.join("; ") + ".";
};
...
function cn(e, t, r, n) {
    return [
        "Invalid ".concat(V.red(n.key(e)), " value."),
        "Expected ".concat(V.blue(r), ","),
        "but received ".concat(t === Ze ? V.gray("nothing") : V.red(n.value(t)), ".")
    ].join(" ");
}
function ln(param, r) {
    let { text: e, list: t } = param;
    let n = [];
    return e && n.push("- ".concat(V.blue(e))), t && n.push([
        "- ".concat(V.blue(t.title), ":")
...
var et = (e, t, param)=>{
    let { descriptor: r, logger: n, schemas: u } = param;
    let o = [
        "Ignored unknown option ".concat(V.yellow(r.pair({
            key: e,
            value: t
        })), ".")
    ], i = Object.keys(u).sort().find((s)=>vt(e, s) < 3);
    i && o.push("Did you mean ".concat(V.blue(r.key(i)), "?")), n.warn(o.join(" "));
};
var so = [
    "default",
    "expected",
...
function Do(e, t, r) {
    return typeof e == "function" ? function() {
        ...
        return e(...n.slice(0, r - 1), t, ...n.slice(r - 1));
    } : ()=>e;
}
...
function En(e, t) {
    ...
    for (let n of e){
        let u = n[t];
        if (r[u]) throw new Error("Duplicate ".concat(t, " ").concat(JSON.stringify(u)));
        r[u] = n;
    }
    return r;
}
function Cn(e, t) {
    ...
    for (let n of e){
        let u = n[t];
        if (r.has(u)) throw new Error("Duplicate ".concat(t, " ").concat(JSON.stringify(u)));
        r.set(u, n);
    }
    return r;
}
...
var it = class extends b {
    expected(param) {
        ...
        let r = Array.from(this._choices.keys()).map((i)=>this._choices.get(i)).filter((param)=>{
            let { hidden: i } = param;
            return !i;
        }).map((i)=>i.value).sort(An).map(t.value), n = r.slice(0, -2), u = r.slice(-2);
        return {
    ...
    _applyNormalization(t, r) {
        ...
        for (let i of u){
            ...
            let c = (param)=>{
                ...
                let { value: F, redirectTo: f } = param;
...
var Ut;
function lo(e, t) {
    let { logger: r = !1, isCLI: n = !1, passThrough: u = !1, FlagSchema: o, descriptor: i } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    if (n) {
...
function Fo(e, param) {
    let { isCLI: t, FlagSchema: r } = param;
    let n = [];
    t && n.push(rt.create({
        name: "_"
    }));
...
function po(e, param) {
    let { isCLI: t, optionInfos: r, FlagSchema: n } = param;
    let { name: u } = e, o = {
        name: u
    }, i, s = {};
    switch(e.type){
        ...
        case "flag":
            i = n, o.flags = r.flatMap((a)=>[
                    ...
                    a.oppositeDescription && "no-".concat(a.name)
                ].filter(Boolean));
            break;
        case "path":
            i = Ie;
...
function $t(e, t) {
    ...
    if (r) return r;
    let n = "Couldn't resolve parser \"".concat(t, '".');
...
function Sn(e, t) {
    ...
    if (r) return r;
    let n = "Couldn't find plugin for AST format \"".concat(t, '".');
    throw n += " Plugins must be explicitly added to the standalone bundle.", new ve(n);
}
function Re(param) {
    let { plugins: e, parser: t } = param;
    let r = $t(e, t);
    return Wt(r, t);
}
function Wt(e, t) {
...
async function Eo(e) {
    ...
    if (!r.parser) if (r.filepath) {
        ...
        }), !r.parser) throw new Le('No parser could be inferred for file "'.concat(r.filepath, '".'));
    ...
    r.printer = a;
    let c = s.defaultOptions ? Object.fromEntries(Object.entries(s.defaultOptions).filter((param)=>{
        let [, l] = param;
        return l !== void 0;
    })) : {}, D = {
        ...u,
...
async function Ln(e, t, r, n, u) {
    ...
    var _i_getVisitorKeys;
    let c = J((_i_getVisitorKeys = i.getVisitorKeys) !== null && _i_getVisitorKeys !== void 0 ? _i_getVisitorKeys : a), D = [];
    F();
    let p = e.stack;
...
async function Gt(e, t) {
    var _e_comments;
    let r = (_e_comments = e.comments) !== null && _e_comments !== void 0 ? _e_comments : [];
...
function wo(e, t) {
    ...
    if (!r) return e;
    var _r_ignoredProperties;
    let u = J(n), o = (_r_ignoredProperties = r.ignoredProperties) !== null && _r_ignoredProperties !== void 0 ? _r_ignoredProperties : new Set;
    return i(e);
    //TURBOPACK unreachable
    ;
    function i(s, a) {
        ...
        let p = r(s, c, a);
        if (p !== null) return p !== null && p !== void 0 ? p : c;
    }
}
var Yn = wo;
var bo = (e, t, r)=>{
...
var ko = (param)=>{
    let { parser: e } = param;
    return e === "json" || e === "json5" || e === "jsonc" || e === "json-stringify";
};
function So(e, t) {
    let r = [
        e.node,
...
function To(e, t, param) {
    let { locStart: r, locEnd: n } = param;
...
function zt(e, t, r, n) {
    let u = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [], o = arguments.length > 5 ? arguments[5] : void 0;
...
function Jn(e, t) {
    ...
    if (i && (e = e.slice(1), r--, n--, u--), o === "auto" && (o = nr(e)), e.includes("\r")) {
        let s = (a)=>Ct(e.slice(0, Math.max(a, 0)), "\r\n");
...
function Mo(e, t) {
    let r = e.match(new RegExp("(".concat(Xt(t), ")+"), "gu"));
...
var au = Ho;
function Jo(e, t, r) {
    let n = t === '"' ? "'" : '"', o = te(!1, e, RegExp("\\\\(.)|([\"'])", "gsu"), (i, s, a)=>s === n ? s : a === t ? "\\" + a : a || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(s) ? s : "\\" + s));
    return t + o + t;
}
var Du = Jo;
function qo(e, t, r) {
...
function ce(e) {
    ...
    return async function() {
        ...
        var _r_t, _n_plugins;
        let n = (_r_t = r[t]) !== null && _r_t !== void 0 ? _r_t : {}, u = (_n_plugins = n.plugins) !== null && _n_plugins !== void 0 ? _n_plugins : [];
        return r[t] = {
            ...n,
...
//# sourceMappingURL=node_modules_prettier_standalone_mjs_07ee92b9._.js.map