...
"[project]/node_modules/prettier/plugins/babel.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
(function(f) {
    ...
    var Ci = (a, t)=>()=>(t || a((t = {
                exports: {}
            }).exports, t), t.exports), Ue = (a, t)=>{
        for(var e in t)be(a, e, {
            get: t[e],
            enumerable: !0
        });
    }, os = (a, t, e, s)=>{
        if (t && typeof t == "object" || typeof t == "function") for (let i of Ai(t))!Ei.call(a, i) && i !== e && be(a, i, {
            get: ()=>t[i],
            enumerable: !(s = bi(t, i)) || s.enumerable
        });
        return a;
    };
    var ls = (a, t, e)=>(e = a != null ? Ti(Si(a)) : {}, os(t || !a || !a.__esModule ? be(e, "default", {
            value: a,
            enumerable: !0
        }) : e, a)), wi = (a)=>os(be({}, "__esModule", {
            value: !0
        }), a);
    var Tt = Ci((Pe)=>{
        "use strict";
        ...
        var hs = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", Ni = {
        ...
        }, Ee = (a)=>a.type === "UpdateExpression" ? cs.UpdateExpression["".concat(a.prefix)] : cs[a.type], ki = {
            ...
            ExportBindingIsString: (param)=>{
                let { localName: a, exportName: t } = param;
            ...
            UnexpectedToken: (param)=>{
                let { expected: a, unexpected: t } = param;
            ...
            UnsupportedMetaProperty: (param)=>{
                let { target: a, onlyValidPropertyName: t } = param;
            ...
            ParseExpressionExpectsEOF: (param)=>{
                let { unexpected: a } = param;
                return "Unexpected parseExpression() input: The input should contain exactly one expression, but the first expression is followed by the unexpected character `".concat(String.fromCodePoint(a), "`.");
            }
        }, Di = new Set([
        ...
        function Fi(param) {
            let { toMessage: a, code: t, reasonCode: e, syntaxPlugin: s } = param;
            ...
            return function r(n, o) {
                ...
                return l.code = t, l.reasonCode = e, l.loc = n, l.pos = n.index, l.syntaxPlugin = s, i && (l.missingPlugin = o.missingPlugin), ps(l, "clone", function() {
                    ...
                    configurable: !0,
                    get () {
                        let h = "".concat(a(o), " (").concat(n.line, ":").concat(n.column, ")");
        ...
        function F(a, t) {
            ...
            for (let s of Object.keys(a)){
                let i = a[s], r = typeof i == "string" ? {
                    ...
                    message: i
                } : i, { message: n } = r, o = Ii(r, Oi), l = typeof n == "string" ? ()=>n : n;
        ...
        var p = Object.assign({}, F(Ni), F(ki), F(vi), F(Li), F(_templateObject())(Mi));
        function Bi() {
            return {
                sourceType: "script",
        ...
        var Ui = (a)=>{
            class _class extends a {
                ...
                parseMethod(e, s, i, r, n, o) {
                    let l = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : !1;
        ...
        C.template = new X("`", !0);
        var T = !0, m = !0, je = !0, ce = !0, V = !0, ji = !0, Ie = class {
            constructor(t, e = {}){
        ...
        function P(a) {
            let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            var e, s, i, r;
            return ++de, ut.push(a), ft.push((e = t.binop) != null ? e : -1), dt.push((s = t.beforeExpr) != null ? s : !1), mt.push((i = t.startsExpr) != null ? i : !1), yt.push((r = t.prefix) != null ? r : !1), _.push(new Ie(a, t)), de;
        }
        function b(a) {
            let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            var e, s, i, r;
            return ++de, pt.set(a, de), ut.push(a), ft.push((e = t.binop) != null ? e : -1), dt.push((s = t.beforeExpr) != null ? s : !1), mt.push((i = t.startsExpr) != null ? i : !1), yt.push((r = t.prefix) != null ? r : !1), _.push(new Ie("name", t)), de;
        }
        var $i = {
            bracketL: P("[", {
                beforeExpr: T,
        ...
        var me = class {
            ...
            EnumBooleanMemberNotInitialized: (param)=>{
                let { memberName: a, enumName: t } = param;
            ...
            EnumInvalidExplicitType: (param)=>{
                let { invalidEnumType: a, enumName: t } = param;
            ...
            EnumInvalidMemberInitializerPrimaryType: (param)=>{
                let { enumName: a, memberName: t, explicitType: e } = param;
            ...
            EnumInvalidMemberInitializerSymbolType: (param)=>{
                let { enumName: a, memberName: t } = param;
            ...
            EnumInvalidMemberName: (param)=>{
                let { enumName: a, memberName: t, suggestion: e } = param;
            ...
            UnsupportedDeclareExportKind: (param)=>{
                let { unsupportedExportKind: a, suggestion: t } = param;
        ...
        var ur = /\*?\s*@((?:no)?flow)\b/, fr = (a)=>{
            class _class extends a {
                ...
                checkReservedType(e, s, i) {
                    lr.has(e) && this.raise(i ? g.AssignReservedType : g.UnexpectedReservedType, s, {
                        reservedType: e
                    });
                }
                ...
                flowParseObjectType(param) {
                    let { allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n } = param;
                    ...
                    for(s && this.match(6) ? (this.expect(6), h = 9, c = !0) : (this.expect(5), h = 8, c = !1), l.exact = c; !this.match(h);){
                        ...
                        if (this.eat(0)) x != null && this.unexpected(x), this.eat(0) ? (S && this.unexpected(S.loc.start), l.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, d))) : l.indexers.push(this.flowParseObjectTypeIndexer(N, d, S));
                            ...
                            let W = this.flowParseObjectTypeProperty(N, d, x, S, I, i, n !== null && n !== void 0 ? n : !c);
                ...
                flowParseQualifiedTypeIdentifier(e, s) {
                    e !== null && e !== void 0 ? e : e = this.state.startLoc;
                        ...
                        case 10:
                            {
                                ...
                                ]) : i = this.flowParseFunctionTypeParams(), l.params = i.params, l.rest = i.rest, l.this = i._this, this.expect(11), this.expect(19), l.returnType = this.flowParseType(), l.typeParameters = null, this.finishNode(l, "FunctionTypeAnnotation");
                            }
                        case 134:
                ...
                flowEnumErrorBooleanMemberNotInitialized(e, param) {
                    let { enumName: s, memberName: i } = param;
                ...
                flowEnumMembers(param) {
                    let { enumName: e, explicitType: s } = param;
                    let i = new Set, r = {
                        booleanMembers: [],
                        numberMembers: [],
                        stringMembers: [],
                ...
                flowEnumStringMembers(e, s, param) {
                    let { enumName: i } = param;
            ...
            class _class extends a {
                jsxReadToken() {
                    ...
                    for(;;){
                        ...
                        switch(i){
                            ...
                            case 125:
                            default:
                                ee(i) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(!0), s = this.state.pos) : ++this.state.pos;
                        }
                    }
                }
                jsxReadNewLine(e) {
                ...
                jsxParseElementAt(e) {
                    ...
                    if (!r.selfClosing) {
                        ...
                        q(r) && !q(n) && n !== null ? this.raise(J.MissingClosingTagFragment, n) : !q(r) && q(n) ? this.raise(J.MissingClosingTagElement, n, {
                            openingTagName: Q(r.name)
                        }) : !q(r) && !q(n) && Q(n.name) !== Q(r.name) && this.raise(J.MissingClosingTagElement, n, {
                            openingTagName: Q(r.name)
                        });
                    }
        ...
        var Qe = class extends Ye {
            ...
            init(param) {
                let { strictMode: t, sourceType: e, startIndex: s, startLine: i, startColumn: r } = param;
        ...
        function Ds(a, t, e, s, i, r, n, o, l, h) {
            let c = t, u = i === 16 ? ys.hex : ys.decBinOct, f = i === 16 ? Se.hex : i === 10 ? Se.dec : i === 8 ? Se.oct : Se.bin, d = !1, x = 0;
            for(let A = 0, N = r !== null && r !== void 0 ? r : 1 / 0; A < N; ++A){
        ...
        var br = new Set([
            ...
            setStrict(t) {
                this.state.strict = t, t && (this.state.strictErrors.forEach((param)=>{
                    let [e, s] = param;
            ...
            readInt(t, e) {
                let s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1, i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0;
            ...
            checkKeywordEscapes() {
                ...
                xt(t) && this.state.containsEsc && this.raise(p.InvalidEscapedReservedWord, this.state.startLoc, {
                    reservedWord: H(t)
                });
            }
            raise(t, e) {
            ...
            constructor(t, e){
                super(), this.isLookahead = void 0, this.tokens = [], this.errorHandlers_readInt = {
                    invalidDigit: (s, i, r, n)=>this.optionFlags & 2048 ? (this.raise(p.InvalidDigit, pe(s, i, r), {
                            radix: n
                        }), !0) : !1,
            ...
            validateAsPattern() {
                ...
                e.canBeArrowParameterDeclaration() && e.iterateErrors((param)=>{
                    let [s, i] = param;
        ...
        var at = class extends tt {
            ...
            constructor(t, e, s){
                this.type = "", this.start = e, this.end = 0, this.loc = new se(s), (t == null ? void 0 : t.optionFlags) & 128 && (this.range = [
                    e,
                    0
        ...
        var ot = class extends at {
            ...
            parseMaybeDefault(t, e) {
                if (t !== null && t !== void 0 ? t : t = this.state.startLoc, e = e !== null && e !== void 0 ? e : this.parseBindingAtom(), !this.eat(29)) return e;
            ...
            checkLVal(t, e) {
                let s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 64, i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1, r = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !1, n = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !1;
                var o;
                let l = t.type;
                if (this.isObjectMethod(t)) return;
                let h = this.isOptionalMemberExpression(t);
                if (h || l === "MemberExpression") {
                    h && (this.expectPlugin("optionalChainingAssign", t.loc.start), e.type !== "AssignmentExpression" && this.raise(p.InvalidLhsOptionalChaining, t, {
                        ancestor: e
            ...
            checkIdentifier(t, e) {
                ...
                this.state.strict && (s ? vs(t.name, this.inModule) : ks(t.name)) && (e === 64 ? this.raise(p.StrictEvalArguments, t, {
        ...
        var y = F(_templateObject3())({
            ...
            DuplicateAccessibilityModifier: (param)=>{
                let { modifier: a } = param;
                return "Accessibility modifier already seen: '".concat(a, "'.");
            },
            ...
            InvalidHeritageClauseType: (param)=>{
                let { token: a } = param;
                return "'".concat(a, "' list can only include identifiers or qualified-names with optional type arguments.");
            },
            InvalidModifierOnAwaitUsingDeclaration: (a)=>"'".concat(a, "' modifier cannot appear on an await using declaration."),
            ...
            InvalidModifierOnUsingDeclaration: (a)=>"'".concat(a, "' modifier cannot appear on a using declaration."),
            InvalidModifiersOrder: (param)=>{
                let { orderedModifiers: a } = param;
            ...
            UsingDeclarationInAmbientContext: (a)=>"'".concat(a, "' declarations are not allowed in ambient contexts.")
        });
        function wr(a) {
            switch(a){
                case "any":
        ...
        var Nr = (a)=>{
            class _class extends a {
                ...
                tsParseModifiers(param, n) {
                    let { allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = y.InvalidModifierOnTypeMember } = param;
                    let o = (h, c, u, f)=>{
                        c === u && n[f] && this.raise(y.InvalidModifiersOrder, h, {
                            orderedModifiers: [
                                u,
                                f
                            ]
                        ...
                        (n[u] && c === f || n[f] && c === u) && this.raise(y.IncompatibleModifiers, h, {
                            modifiers: [
                                u,
                                f
                            ]
                    ...
                    for(;;){
                        let { startLoc: h } = this.state, c = this.tsParseModifier(e.concat(s !== null && s !== void 0 ? s : []), i, n.static);
                        if (!c) break;
                        gs(c) ? n.accessibility ? this.raise(y.DuplicateAccessibilityModifier, h, {
                            modifier: c
                        }) : (o(h, c, c, "override"), o(h, c, c, "static"), o(h, c, c, "readonly"), n.accessibility = c) : Ir(c) ? (n[c] && this.raise(y.DuplicateModifier, h, {
                            modifier: c
                        }), n[c] = !0, o(h, c, "in", "out")) : (hasOwnProperty.call(n, c) ? this.raise(y.DuplicateModifier, h, {
                            modifier: c
                        }) : (o(h, c, "static", "readonly"), o(h, c, "static", "override"), o(h, c, "override", "readonly"), o(h, c, "abstract", "override"), l(h, c, "declare", "override"), l(h, c, "static", "abstract")), n[c] = !0), s != null && s.includes(c) && this.raise(r, h, {
                            modifier: c
                        });
                    }
                }
                ...
                tsParseImportTypeOptions() {
                    ...
                    ], this.expect(8), this.finishNode(e, "ObjectExpression");
                }
                ...
                parseClassProperty(e) {
                    if (this.parseClassPropertyAnnotation(e), this.state.isAmbientContext && !(e.readonly && !e.typeAnnotation) && this.match(29) && this.raise(y.DeclareClassFieldHasInitializer, this.state.startLoc), e.abstract && this.match(29)) {
                        ...
                        this.raise(y.AbstractPropertyHasInitializer, this.state.startLoc, {
                            propertyName: s.type === "Identifier" && !e.computed ? s.name : "[".concat(this.input.slice(this.offsetToSourcePos(s.start), this.offsetToSourcePos(s.end)), "]")
                        });
                    }
                ...
                pushClassMethod(e, s, i, r, n, o) {
                    ...
                    h && (c === "get" || c === "set") && this.raise(y.DeclareAccessor, s, {
                        kind: c
                    }), l && (s.typeParameters = l), super.pushClassMethod(e, s, i, r, n, o);
                }
                pushClassPrivateMethod(e, s, i, r) {
                ...
                parseMethod(e, s, i, r, n, o, l) {
                    ...
                    if ((h.abstract || h.type === "TSAbstractMethodDefinition") && (this.hasPlugin("estree") ? h.value : h).body) {
                        ...
                        this.raise(y.AbstractMethodHasImplementation, h, {
                            methodName: f.type === "Identifier" && !h.computed ? f.name : "[".concat(this.input.slice(this.offsetToSourcePos(f.start), this.offsetToSourcePos(f.end)), "]")
                        });
                    }
                    return h;
                }
                ...
                fillOptionalPropertiesForTSESLint(e) {
                    ...
                    switch(e.type){
                        ...
                        case "AssignmentPattern":
                        case "ObjectPattern":
                            (i = e.decorators) != null || (e.decorators = []), (r = e.optional) != null || (e.optional = !1), (n = e.typeAnnotation) != null || (e.typeAnnotation = void 0);
                            return;
                        case "TSParameterProperty":
                            (o = e.accessibility) != null || (e.accessibility = void 0), (l = e.decorators) != null || (e.decorators = []), (h = e.override) != null || (e.override = !1), (c = e.readonly) != null || (e.readonly = !1), (u = e.static) != null || (e.static = !1);
                            return;
                        ...
                        case "ClassMethod":
                        case "ClassPrivateMethod":
                            (f = e.declare) != null || (e.declare = !1), (d = e.returnType) != null || (e.returnType = void 0), (x = e.typeParameters) != null || (e.typeParameters = void 0);
                            return;
                        case "Property":
                        ...
                        case "TSIndexSignature":
                            (S = e.accessibility) != null || (e.accessibility = void 0), (I = e.readonly) != null || (e.readonly = !1), (W = e.static) != null || (e.static = !1);
                            return;
                        case "TSAbstractPropertyDefinition":
                        case "PropertyDefinition":
                        case "TSAbstractAccessorProperty":
                        case "AccessorProperty":
                            ($ = e.declare) != null || (e.declare = !1), (Mt = e.definite) != null || (e.definite = !1), (Ot = e.readonly) != null || (e.readonly = !1), (Ft = e.typeAnnotation) != null || (e.typeAnnotation = void 0);
                        case "TSAbstractMethodDefinition":
                        case "MethodDefinition":
                            (Bt = e.accessibility) != null || (e.accessibility = void 0), (Rt = e.decorators) != null || (e.decorators = []), (_t = e.override) != null || (e.override = !1), (Ut = e.optional) != null || (e.optional = !1);
                            return;
                        case "ClassExpression":
                            (jt = e.id) != null || (e.id = null);
                        case "ClassDeclaration":
                            ($t = e.abstract) != null || (e.abstract = !1), (Vt = e.declare) != null || (e.declare = !1), (qt = e.decorators) != null || (e.decorators = []), (zt = e.implements) != null || (e.implements = []), (Ht = e.superTypeArguments) != null || (e.superTypeArguments = void 0), (Kt = e.typeParameters) != null || (e.typeParameters = void 0);
                            return;
                        ...
                        case "VariableDeclarator":
                            ...
                            return;
                        case "TSEnumDeclaration":
                            (Xt = e.const) != null || (e.const = !1), (Gt = e.declare) != null || (e.declare = !1);
                            return;
                        case "TSEnumMember":
                        ...
                        case "TSInterfaceDeclaration":
                            (es = e.declare) != null || (e.declare = !1), (ts = e.extends) != null || (e.extends = []);
                            return;
                        case "TSModuleDeclaration":
                            (ss = e.declare) != null || (e.declare = !1), (is = e.global) != null || (e.global = e.kind === "global");
                            return;
                        case "TSTypeParameter":
                            (rs = e.const) != null || (e.const = !1), (as = e.in) != null || (e.in = !1), (ns = e.out) != null || (e.out = !1);
                            return;
                    }
                }
                constructor(...e){
        ...
        function Or(a) {
            ...
            if (a.has("pipelineOperator")) {
                ...
                if (!bs.includes(s)) {
                    let i = bs.map((r)=>'"'.concat(r, '"')).join(", ");
                    throw new Error('"pipelineOperator" requires "proposal" option whose value must be one of: '.concat(i, "."));
                }
                if (s === "hack") {
                    ...
                    if (!As.includes(i)) {
                        let r = As.map((n)=>'"'.concat(n, '"')).join(", ");
                        throw new Error('"pipelineOperator" in "proposal": "hack" mode also requires a "topicToken" option whose value must be one of: '.concat(r, "."));
                    }
                    {
                        var e;
                        if (i === "#" && ((e = a.get("recordAndTuple")) == null ? void 0 : e.syntaxType) === "hash") throw new Error('Plugin conflict between `["pipelineOperator", { proposal: "hack", topicToken: "#" }]` and `'.concat(JSON.stringify([
                            "recordAndTuple",
                            a.get("recordAndTuple")
                        ]), "`."));
                    }
                } else if (s === "smart" && ((t = a.get("recordAndTuple")) == null ? void 0 : t.syntaxType) === "hash") throw new Error('Plugin conflict between `["pipelineOperator", { proposal: "smart" }]` and `'.concat(JSON.stringify([
                    "recordAndTuple",
                    a.get("recordAndTuple")
                ]), "`."));
            }
            ...
            if (!a.has("deprecatedImportAssert") && a.has("importAttributes") && a.get("importAttributes").deprecatedAssertSyntax && a.set("deprecatedImportAssert", {}), a.has("recordAndTuple")) {
                ...
                if (s != null) {
                    ...
                    if (!i.includes(s)) throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + i.map((r)=>"'".concat(r, "'")).join(", "));
                }
            }
        ...
        var _s = {
            ...
            parseExprOp(t, e, s) {
                if (this.isPrivateName(t)) {
                    ...
                    (s >= Ce(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(p.PrivateInExpectedIn, t, {
                        identifierName: r
                ...
                if (Ki(i) && (this.prodParam.hasIn || !this.match(58))) {
                    ...
                    if (r > s) {
                        ...
                        if (l && (r = Ce(42)), this.next(), i === 39 && this.hasPlugin([
                            "pipelineOperator",
                            {
                                proposal: "minimal"
                            }
            ...
            parseHackPipeBody() {
                ...
                return Di.has(s.type) && !((t = s.extra) != null && t.parenthesized) && this.raise(p.PipeUnparenthesizedBody, e, {
                    type: s.type
            ...
            parsePropertyDefinition(t) {
                ...
                if (this.parsePropertyName(s, t), !o && !l && this.maybeAsyncOrAccessorProp(s)) {
                    ...
                    c === "async" && !this.hasPrecedingLineBreak() && (i = !0, this.resetPreviousNodeTrailingComments(h), o = this.eat(55), this.parsePropertyName(s)), (c === "get" || c === "set") && (r = !0, this.resetPreviousNodeTrailingComments(h), s.kind = c, this.match(55) && (o = !0, this.raise(p.AccessorIsGenerator, this.state.curPosition(), {
                        kind: c
        ...
        var ct = class extends ht {
            ...
            parseProgram(t) {
                let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 140, s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : this.options.sourceType;
            ...
            parseBlock() {
                let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, s = arguments.length > 2 ? arguments[2] : void 0;
                let i = this.startNode();
            ...
            parseFunction(t) {
                ...
                return this.state.maybeInArrowParameters = !1, this.scope.enter(514), this.prodParam.enter(we(n, t.generator)), i || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, !1), this.withSmartMixTopicForbiddingContext(()=>{
            ...
            parseClassId(t, e, s) {
                let i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 8331;
            ...
            shouldParseExportDeclaration() {
                let { type: t } = this.state;
                if (t === 26 && (this.expectOnePlugin([
                    "decorators",
                    "decorators-legacy"
                ]), this.hasPlugin("decorators"))) return this.getPluginOption("decorators", "decoratorsBeforeExport") === !0 && this.raise(p.DecoratorBeforeExport, this.state.startLoc), !0;
            ...
            isJSONModuleImport(t) {
                return t.assertions != null ? t.assertions.some((param)=>{
                    let { key: e, value: s } = param;
            ...
            finishImportSpecifier(t, e) {
                let s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 8201;
    ...
    function v(a) {
        var s, i, r;
        var _ref, _ref1;
        let t = (_ref = (s = a.range) == null ? void 0 : s[0]) !== null && _ref !== void 0 ? _ref : a.start, e = (r = (_ref1 = (i = a.declaration) == null ? void 0 : i.decorators) !== null && _ref1 !== void 0 ? _ref1 : a.decorators) == null ? void 0 : r[0];
        return e ? Math.min(v(e), t) : t;
    }
    function k(a) {
        var e;
        var _ref;
        return (_ref = (e = a.range) == null ? void 0 : e[1]) !== null && _ref !== void 0 ? _ref : a.end;
    }
    function Zr(a) {
        let t = new Set(a);
    ...
    function na(a) {
        ...
        for(let e = a.length - 1; e >= 0; e--){
            let s = a[e];
            if (t && k(s) === v(t) && Et(s) && Et(t) && (a.splice(e + 1, 1), s.value += "*//*" + t.value, s.range = [
                v(s),
                k(t)
            ]), !bt(s) && !G(s)) throw new TypeError('Unknown comment type: "'.concat(s.type, '".'));
            t = s;
        }
    }
    var Gs = na;
    ...
    function Te(a) {
        ...
        return ge = Te.prototype = a !== null && a !== void 0 ? a : Object.create(null), new Te;
    }
    var oa = 10;
    ...
    function la(a) {
        let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "type";
        Ct(a);
        function e(s) {
            let i = s[t], r = a[i];
    ...
    function ca(a, t) {
        ...
        a = ei(a, (l)=>{
            switch(l.type){
                case "ParenthesizedExpression":
                    {
                        ...
                        if (h.type === "TypeCastExpression") return h.range = [
                            c,
                            k(l)
                        ], h;
                        let u = !1;
                ...
                case "TSEnumDeclaration":
                    if (!l.body) {
                        let h = k(l.id), { members: c } = l, u = Js({
                            originalText: s,
                            [Symbol.for("comments")]: i
                        }, h, c[0] ? v(c[0]) : k(l)), f = h + u.indexOf("{");
                        l.body = {
                            type: "TSEnumBody",
                            members: c,
                            range: [
        ...
        return o.interpreter && (i.unshift(o.interpreter), delete o.interpreter), r && a.hashbang && (i.unshift(a.hashbang), delete a.hashbang), a.type === "Program" && (a.range = [
            0,
            s.length
        ]), a;
    }
    ...
    function ua(a) {
        ...
        let o = " (".concat(i, ":").concat(r, ")");
        return t.endsWith(o) && (t = t.slice(0, -o.length)), t.startsWith(ri) && (t = t.slice(ri.length)), Me(t, {
            loc: {
                start: {
                    line: i,
                    column: r + 1
    ...
    function li(a) {
        ...
        let e = "";
        for(; e !== a;)e = a, a = ne(!1, a, Pa, "".concat(t, "$1 $2").concat(t));
        a = a.replace(ai, "").trimEnd();
        let s = Object.create(null), i = ne(!1, a, ni, "").replace(ai, "").trimEnd(), r;
        for(; r = ni.exec(a);){
            let n = ne(!1, r[2], xa, "");
    ...
    var oe = (a)=>Y(Ia(a)), Sa = {
        ...
        let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Sa;
        return {
            ...t,
            plugins: [
                ...t.plugins,
    ...
    function Ia(param) {
        let { isExpression: a = !1, optionsCombinations: t } = param;
        return function(e) {
            let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            let { filepath: i } = s;
            if (typeof i != "string" && (i = void 0), (s.parser === "babel" || s.parser === "__babel_estree") && Ca(e, i)) return s.parser = "babel-flow", Pi.parse(e, s);
            var _s___babelSourceType;
            let r = t, n = (_s___babelSourceType = s.__babelSourceType) !== null && _s___babelSourceType !== void 0 ? _s___babelSourceType : di(i);
            n === kt && (r = r.map((c)=>({
                    ...c,
                    sourceType: n
                })));
    ...
    var Na = new Set([
        ...
        optionsCombinations: xi.map((a)=>j([
                "estree"
            ], a))
    });
    var Dt = {};
    ...
    function _e(a) {
        ...
        return i = Fe(i, {
            type: "JsonRoot",
            text: a
        }), i.node.type === "File" ? delete i.node : le(i.node), i;
    }
    function K(a, t) {
        let [e, s] = [
            a.loc.start,
            ...
            let { line: i, column: r } = param;
            return {
                line: i,
                column: r + 1
            };
        });
        return Me("".concat(t, " is not allowed in JSON."), {
            loc: {
                start: e,
                end: s
            }
            ...
            case "UnaryExpression":
                {
                    ...
                    if (t !== "+" && t !== "-") throw K(a, "Operator '".concat(a.operator, "'"));
                    if (e.type === "NumericLiteral" || e.type === "Identifier" && (e.name === "Infinity" || e.name === "NaN")) return;
                    throw K(e, "Operator '".concat(t, "' before '").concat(e.type, "'"));
                }
            case "Identifier":
                if (a.name !== "Infinity" && a.name !== "NaN" && a.name !== "undefined") throw K(a, "Identifier '".concat(a.name, "'"));
                return;
            case "TemplateLiteral":
...
//# sourceMappingURL=node_modules_prettier_plugins_babel_143d1615.js.map